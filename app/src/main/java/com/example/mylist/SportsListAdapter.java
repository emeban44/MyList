...
public class SportsListAdapter extends BaseAdapter {
    ...
    private List<SportsClub> movies;

    public SportsListAdapter(Context context, List<SportsClub> movies) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SportsClub movie = movies.get(position);
        ...
        rating.setText(movie.getCountry());
        year.setText(movie.getYear());
        genre.setText(movie.getSport());
        return convertView;
    }
}
